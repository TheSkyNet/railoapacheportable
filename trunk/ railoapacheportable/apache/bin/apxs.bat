...
goto endofperl
@rem ';
#!"C:\xampp_RailoPortable2\perl\bin\perl.exe" -w
#line 15
# ====================================================================
#
...
my $installbuilddir = 'C:\xampp_RailoPortable2\apache\build';
...
my $CP    = 'C:\xampp_RailoPortable2\perl\bin\perl.exe -MExtUtils::Command -e cp';
my $CHMOD = 'C:\xampp_RailoPortable2\perl\bin\perl.exe -MExtUtils::Command -e chmod';
my $RM_F  = 'C:\xampp_RailoPortable2\perl\bin\perl.exe -MExtUtils::Command -e rm_f';
my $TOUCH = 'C:\xampp_RailoPortable2\perl\bin\perl.exe -MExtUtils::Command -e touch';
