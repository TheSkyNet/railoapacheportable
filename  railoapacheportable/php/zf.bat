...
REM below "C:\xampp_RailoPortable2\php\php.exe"
FOR %%x IN ("C:\xampp_RailoPortable2\php\php.exe") DO (if %%x=="%TMPZTMPZTMP%" GOTO :NON_PEAR_INSTALLED)
...
SET "PHP_BIN=C:\xampp_RailoPortable2\php\php.exe"
SET "PHP_DIR=C:\xampp_RailoPortable2\php"
GOTO RUN
